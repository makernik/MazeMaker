 ...
 * 
 * For a perfect maze (generated by Prim's or Recursive Backtracker), there is
 * always exactly one path between any two points, so we just need to verify a path exists.
 */
